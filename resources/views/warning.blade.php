      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 h-100">
            <div class="logo">
              <a href="https://shlokitsolution.com/" _target="_blank">
                <img src="https://shlokitsolution.com/web/src/home/image/logo/logo-dark.svg" alt="logo" />
              </a>
            </div>
          </div>
          <div
          ...
          >
            <ul class="m-0">
              <li>
                <a target="_blank" href="https://codecanyon.net/user/shlokitsolution/portfolio">Products</a>
              </li>
              <li>
                <a target="_blank" href="https://shlokitsolution.com/contact-us">Support</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="main">
              <div class="img">
                <img src="https://shlokitsolution.com/image/warning-image.png" alt="hero" />
              </div>
              <div class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="policy policy-extends">
              <img src="https://shlokitsolution.com/image/rockets.png" alt="rocket" />
